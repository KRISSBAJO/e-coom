...
export const Register = () => {
  ...
  async function handleRegister(e) {
      ...
      const result = await register(authDetail);
    ...
    <main>
      <section>
        ...
        <div className="mb-6">
          ...
          <div className="mb-6">
              <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
          ...
          <div className="mb-6">
              <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
