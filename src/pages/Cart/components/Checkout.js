...
export const Checkout = ({ setCheckout }) => {
    ...
    async function handleOrderSubmit(e) {
        ...
        try { 
            ...
            setCheckout(false);
            navigate("/order-summary", { state: {data: null, status : false} });
        }
    }
  return (
    <section>
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50"></div>
        <div id="authentication-modal" tabIndex="-1" className="mt-5 overflow-y-auto overflow-x-hidden fixed top-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full items-center flex">
            ...
            <div className="relative p-4 w-full max-w-md h-full md:h-auto overflow-y-auto">
                ...
                <div className="py-6 px-6 lg:px-8">
                    ...
                    <form onSubmit={handleOrderSubmit}  className="space-y-6" >
                        ...
                        ${typeof total === 'number' ? total.toFixed(2) : total}M
                        </p>
